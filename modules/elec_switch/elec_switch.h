...
// 此处为各电气开关所对应GPIO口的宏定义
#define ELECSWITCH_MAX_NUM 6   // 最大电气开关数量
#define VALVE1_Pin GPIO_PIN_12 // 对应电磁阀第1路 GPIO端口宏定义
#define VALVE1_GPIO_Port GPIOB
#define VALVE2_Pin GPIO_PIN_13 // 对应电磁阀第2路 GPIO端口宏定义
#define VALVE2_GPIO_Port GPIOB
#define VALVE3_Pin GPIO_PIN_14 // 对应电磁阀第3路 GPIO端口宏定义
#define VALVE3_GPIO_Port GPIOB
#define VALVE4_Pin GPIO_PIN_15 // 对应电磁阀第4路 GPIO端口宏定义
#define VALVE4_GPIO_Port GPIOB

#define PUMP1_Pin GPIO_PIN_0 //对应气泵1 GPIO端口定义 c板iic2_sda
#define PUMP2_Pin GPIO_PIN_1 //对应气泵2 GPIO端口定义 c板iic2_scl
